...
contract QIQCrowdsale is Ownable, Crowdsale, MintableToken {
    ...
    /**
    * Pre ICO               - 40% bonus [Min. purchase of 0.5 ETH]
    * Main ICO 1st round    - 25% bonus [Min. purchase of 0.1 ETH]
    * Main ICO 2nd round    - 15% bonus [Min. purchase of 0.1 ETH]
    * Main ICO Final round  -  0% bonus [Min. purchase of 0.1 ETH]
    *
